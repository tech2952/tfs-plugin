...
'On Error Resume Next
	...
	'----------------------------------------------
	Set logFile = fsoLog.CreateTextFile ( strRunDir & "\PATRICKHENRY_Call_Database_Install.txt", TRUE)
	...
	'--------------------------------------------
	strInstallDatabase = strSourceDir + "InstallDatabasePatrickHenry.vbs"
