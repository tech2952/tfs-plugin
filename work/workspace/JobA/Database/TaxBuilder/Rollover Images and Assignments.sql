...
select @OLDYEAR = '6' --2006
select @NEWYEAR = '7' --2007
...
from ImageInfo ii, ImageInfo i2
...
insert into ImageInfo (Version, Image_Name, Image_ID, FileName, Jurisdiction, Document_Code, ImageSize, ImageType, 
...
from PropertyValuesForPage pp, ImageInfo i4
