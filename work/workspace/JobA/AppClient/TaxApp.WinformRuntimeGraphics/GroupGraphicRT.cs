...
namespace TaxApp.WinformRuntimeGraphics
{
	...
	/// </summary>
	public class GroupGraphicRT : LinkLabel, IAmARunTimeControl
	{
		private System.ComponentModel.Container components = null;
		private GroupGraphic myGraphic;
		private int myRunTimeID;
        private int myPageID;
        private int myRecordLineage;

		public GroupGraphicRT()
		{
			InitializeComponent();
		}

		public GroupGraphicRT(GroupGraphic aGroupGraphic)
		{
			InitializeComponent();
			myGraphic = aGroupGraphic;
		...
		{
			//TODO: Group graphics are complicated - the object should be a IBindingList or RecordSet
			get{return null;}
			set{}
		}
