...
namespace TaxApp.WinformRuntimeGraphics
{
	...
	/// </summary>
	public class LinkLabelGraphicRT : LinkLabel, IAmARunTimeControl
	{
		private System.ComponentModel.Container components = null;
		private LinkLabelGraphic myGraphic;
		private int myRunTimeID;
        private int myPageID;
        private int myRecordLineage;

		public LinkLabelGraphicRT()
		{
			InitializeComponent();
		}

		public LinkLabelGraphicRT(LinkLabelGraphic aLinkLabelGraphic)
		{
			InitializeComponent();
			myGraphic = aLinkLabelGraphic;
			RunTimeControlUtilities.SetCommonGraphicProperties(myGraphic, this);

			//set any properties on the control that come from the Graphic
			this.Font = myGraphic.Font;
			this.Text = myGraphic.Text;
			this.ForeColor = myGraphic.TextColor;
	...
	#region IAmARunTimeControl Members
		...
		{
			//TODO: linked label's probably return the page id / graphic id of whomever they are pointed at
			get{return null;}
			set{}
		} 
        ...
        public bool IsShortcut { get { return myGraphic.IsShortCut; } }
