...
namespace TestHarness.DataObjects.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of Enum_DataTypeEntity objects. </summary>
	[Serializable]
	public partial class Enum_DataTypeCollection : EntityCollectionBase
	{
		/// <summary> CTor</summary>
		public Enum_DataTypeCollection():base(new PropertyDescriptorFactory(), typeof(Enum_DataTypeCollection), new Enum_DataTypeEntityFactory(), null)
		{
		}
		...
		public Enum_DataTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse):base(propertyDescriptorFactoryToUse, typeof(Enum_DataTypeCollection), entityFactoryToUse, null)
		{
		}
		...
		public Enum_DataTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, Enum_DataTypeValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeof(Enum_DataTypeCollection), entityFactoryToUse, validatorToUse)
		{
		}
		...
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		///  <param name="validatorToUse">The validator object to use when creating entity objects during a GetMulti() call.</param>
		protected Enum_DataTypeCollection(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, Type typeOfDirectInheritor, IEntityFactory entityFactoryToUse, Enum_DataTypeValidator validatorToUse):base(propertyDescriptorFactoryToUse, typeOfDirectInheritor, entityFactoryToUse, validatorToUse)
		{
		}
		...
		protected Enum_DataTypeCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}



		/// <summary> Retrieves in this Enum_DataTypeCollection object all Enum_DataTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in Enum_DataSourceEntity. 
		...
		public virtual bool GetMultiManyToManyUsingEnum_DataSourceCollectionViaLocatorObjectRecord(IEntity enum_DataSourceInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, int pageNumber, int pageSize)
		{
			...
			Enum_DataTypeDAO dao = DAOFactory.CreateEnum_DataTypeDAO();
		...
		/// <summary> Retrieves in this Enum_DataTypeCollection object all Enum_DataTypeEntity objects which are related via a  Relation of type 'm:n' with the passed in LocatorEntity. 
		/// All current elements in the collection are removed from the collection.</summary>
		...
		/// <summary> Deletes from the persistent storage all Enum_DataType entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all Enum_DataType entities from the persistent storage</param>
		...
		/// <summary> Updates in the persistent storage all entities which have data in common with the specified Enum_DataTypeEntity. If one is omitted that entity is not used as a filter. Which fields are updated in those matching entities depends on which fields are
		/// <i>changed</i> in entityWithNewValues. The new values of these fields are read from entityWithNewValues. </summary>
		/// <param name="entityWithNewValues">Enum_DataTypeEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		...
		/// will result in an update action which will affect all Enum_DataType entities.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(Enum_DataTypeEntity entityWithNewValues, IPredicate updateFilter)
		{
			Enum_DataTypeDAO dao = DAOFactory.CreateEnum_DataTypeDAO();
		...
		/// <param name="relations">The set of relations to walk to construct the total query.</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(Enum_DataTypeEntity entityWithNewValues, IPredicate updateFilter, IRelationCollection relations)
		{
			Enum_DataTypeDAO dao = DAOFactory.CreateEnum_DataTypeDAO();
		...
		{
			return "Enum_DataTypeCollection";
		}
		...
		public object GetScalar(Enum_DataTypeFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(Enum_DataTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(Enum_DataTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(Enum_DataTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(Enum_DataTypeFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
		...
		{
			return DAOFactory.CreateEnum_DataTypeDAO();
		}

		#region Class Property Declarations
		/// <summary> Strong typed indexer. </summary>
		public  Enum_DataTypeEntity this [int index]
		{
			get { return (Enum_DataTypeEntity)List[index]; }
		}
		#endregion
