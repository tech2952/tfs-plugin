...
namespace TestHarness.DataObjects.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ClientCustomer'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ClientCustomerEntity : EntityBase, ISerializable
			...
			
	{
		...
		/// <summary>CTor</summary>
		/// <param name="product_Year">PK value for ClientCustomer which data should be fetched into this ClientCustomer object</param>
		/// <param name="client_ID">PK value for ClientCustomer which data should be fetched into this ClientCustomer object</param>
		/// <param name="customer_ID">PK value for ClientCustomer which data should be fetched into this ClientCustomer object</param>
		public ClientCustomerEntity(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID)
		{
			InitClassFetch(product_Year, client_ID, customer_ID, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		public ClientCustomerEntity(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(product_Year, client_ID, customer_ID, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), prefetchPathToUse);
		}
		...
		/// <param name="client_ID">PK value for ClientCustomer which data should be fetched into this ClientCustomer object</param>
		/// <param name="customer_ID">PK value for ClientCustomer which data should be fetched into this ClientCustomer object</param>
		/// <param name="validator">The custom validator object for this ClientCustomerEntity</param>
		public ClientCustomerEntity(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, ClientCustomerValidator validator)
		{
			InitClassFetch(product_Year, client_ID, customer_ID, validator, new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		public ClientCustomerEntity(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, ClientCustomerValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(product_Year, client_ID, customer_ID, validator, propertyDescriptorFactoryToUse, entityFactoryToUse, null);
		}

		/// <summary>CTor</summary>
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public ClientCustomerEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		protected ClientCustomerEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID)
		{
			return FetchUsingPK(product_Year, client_ID, customer_ID, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(product_Year, client_ID, customer_ID, prefetchPathToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(product_Year, client_ID, customer_ID, prefetchPathToUse, contextToUse);
		}
		...
		{
			return Fetch(this.Product_Year, this.Client_ID, this.Customer_ID, null, null);
		}
		...
		public bool TestOriginalFieldValueForNull(ClientCustomerFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ClientCustomerFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ClientCustomerEntity", ((TestHarness.DataObjects.EntityType)typeOfEntity).ToString());
		}
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn)
			{
				switch((ClientCustomerFieldIndex)fieldIndex)
				{
		...
		{
			ClientCustomerDAO dao = (ClientCustomerDAO)CreateDAOInstance();
		...
		{
			return new ClientCustomerValidator();
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="validator">The validator object for this ClientCustomerEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, IValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, IPrefetchPath prefetchPathToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);

			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(product_Year, client_ID, customer_ID, prefetchPathToUse, null);
		...
		private void DesetupSyncClient(bool signalRelatedEntity)
		{
			if(_client != null)
			{
				...
				_client.AfterSave-=new EventHandler(OnEntityAfterSave);
				base.UnsetEntitySyncInformation("Client", _client, ClientCustomerEntity.Relations.ClientEntityUsingProduct_YearClient_ID);
				if(signalRelatedEntity)
				{
					_client.UnsetRelatedEntity(this, "ClientCustomer");
				}
				SetNewFieldValue((int)ClientCustomerFieldIndex.Product_Year, null, false);
				SetNewFieldValue((int)ClientCustomerFieldIndex.Client_ID, null, false);
				_client = null;
			}
		}
		...
		private void SetupSyncClient(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_alreadyFetchedClient = true;
				_client.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Client", _client, ClientCustomerEntity.Relations.ClientEntityUsingProduct_YearClient_ID);
		...
		private void DesetupSyncCustomerName(bool signalRelatedEntity)
		{
			if(_customerName != null)
			{
				...
				_customerName.AfterSave-=new EventHandler(OnEntityAfterSave);
				base.UnsetEntitySyncInformation("CustomerName", _customerName, ClientCustomerEntity.Relations.CustomerNameEntityUsingCustomer_ID);
				if(signalRelatedEntity)
				{
					_customerName.UnsetRelatedEntity(this, "ClientCustomer");
				}
				SetNewFieldValue((int)ClientCustomerFieldIndex.Customer_ID, null, false);
				_customerName = null;
			}
		}
		...
		private void SetupSyncCustomerName(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_alreadyFetchedCustomerName = true;
				_customerName.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("CustomerName", _customerName, ClientCustomerEntity.Relations.CustomerNameEntityUsingCustomer_ID);
		...
		/// <param name="contextToUse">The context to add the entity to if the fetch was succesful. </param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int16 product_Year, System.Int32 client_ID, System.Int32 customer_ID, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)ClientCustomerFieldIndex.Product_Year].ForcedCurrentValueWrite(product_Year);
				base.Fields[(int)ClientCustomerFieldIndex.Client_ID].ForcedCurrentValueWrite(client_ID);
				base.Fields[(int)ClientCustomerFieldIndex.Customer_ID].ForcedCurrentValueWrite(customer_ID);
		...
		{
			return DAOFactory.CreateClientCustomerDAO();
		}
		...
		{
			return new ClientCustomerEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static ClientCustomerRelations Relations
		{
			get	{ return new ClientCustomerRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathClient
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.ClientCollection(),
					ClientCustomerEntity.Relations.ClientEntityUsingProduct_YearClient_ID, 
					(int)TestHarness.DataObjects.EntityType.ClientCustomerEntity, (int)TestHarness.DataObjects.EntityType.ClientEntity, 0, null, null, null, "Client", RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathCustomerName
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(),
					ClientCustomerEntity.Relations.CustomerNameEntityUsingCustomer_ID, 
					(int)TestHarness.DataObjects.EntityType.ClientCustomerEntity, (int)TestHarness.DataObjects.EntityType.CustomerNameEntity, 0, null, null, null, "CustomerName", RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ClientCustomerEntity.CustomProperties;}
		}
		...
		{
			get { return ClientCustomerEntity.FieldsCustomProperties;}
		}

		/// <summary> The Product_Year property of the Entity ClientCustomer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ClientCustomer"."Product_Year"<br/>
		...
		public virtual System.Int16 Product_Year
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ClientCustomerFieldIndex.Product_Year);
			...
			set	{ SetNewFieldValue((int)ClientCustomerFieldIndex.Product_Year, value); }
		}
		/// <summary> The Client_ID property of the Entity ClientCustomer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ClientCustomer"."Client_ID"<br/>
		...
		public virtual System.Int32 Client_ID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ClientCustomerFieldIndex.Client_ID);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)ClientCustomerFieldIndex.Client_ID, value); }
		}
		/// <summary> The Customer_ID property of the Entity ClientCustomer<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ClientCustomer"."Customer_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Int32 Customer_ID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)ClientCustomerFieldIndex.Customer_ID);
				if(valueToReturn == null)
				{
					valueToReturn = TypeDefaultValue.GetDefaultValue(typeof(System.Int32));
				}
			...
			set	{ SetNewFieldValue((int)ClientCustomerFieldIndex.Customer_ID, value); }
		}
		...
		public virtual ClientEntity Client
		{
			...
			set
			{
				...
				else
				{
					...
					{
						((IEntity)value).SetRelatedEntity(this, "ClientCustomer");
					}
				}
			}
		}
		...
		{ 
			get { return (int)TestHarness.DataObjects.EntityType.ClientCustomerEntity; }
		}
		#endregion
