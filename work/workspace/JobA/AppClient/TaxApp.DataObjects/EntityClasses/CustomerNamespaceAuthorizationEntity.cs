...
namespace TestHarness.DataObjects.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'CustomerNamespaceAuthorization'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CustomerNamespaceAuthorizationEntity : EntityBase, ISerializable
			...
			
	{
		...
		/// <summary>Event which is thrown when Authorized_Namespace changes value. Databinding related.</summary>
		public event EventHandler Authorized_NamespaceChanged;
		...
		static CustomerNamespaceAuthorizationEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public CustomerNamespaceAuthorizationEntity()
		{
		...
		/// <summary>CTor</summary>
		/// <param name="product_Year">PK value for CustomerNamespaceAuthorization which data should be fetched into this CustomerNamespaceAuthorization object</param>
		/// <param name="customer_ID">PK value for CustomerNamespaceAuthorization which data should be fetched into this CustomerNamespaceAuthorization object</param>
		/// <param name="authorized_Namespace">PK value for CustomerNamespaceAuthorization which data should be fetched into this CustomerNamespaceAuthorization object</param>
		public CustomerNamespaceAuthorizationEntity(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace)
		{
			InitClassFetch(product_Year, customer_ID, authorized_Namespace, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		public CustomerNamespaceAuthorizationEntity(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, IPrefetchPath prefetchPathToUse)
		{
			InitClassFetch(product_Year, customer_ID, authorized_Namespace, CreateValidator(), new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), prefetchPathToUse);
		}
		...
		/// <param name="customer_ID">PK value for CustomerNamespaceAuthorization which data should be fetched into this CustomerNamespaceAuthorization object</param>
		/// <param name="authorized_Namespace">PK value for CustomerNamespaceAuthorization which data should be fetched into this CustomerNamespaceAuthorization object</param>
		/// <param name="validator">The custom validator object for this CustomerNamespaceAuthorizationEntity</param>
		public CustomerNamespaceAuthorizationEntity(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, CustomerNamespaceAuthorizationValidator validator)
		{
			InitClassFetch(product_Year, customer_ID, authorized_Namespace, validator, new PropertyDescriptorFactory(), CreateEntityFactoryInstance(), null);
		}
		...
		public CustomerNamespaceAuthorizationEntity(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, CustomerNamespaceAuthorizationValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			InitClassFetch(product_Year, customer_ID, authorized_Namespace, validator, propertyDescriptorFactoryToUse, entityFactoryToUse, null);
		}

		/// <summary>CTor</summary>
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public CustomerNamespaceAuthorizationEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		protected CustomerNamespaceAuthorizationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace)
		{
			return FetchUsingPK(product_Year, customer_ID, authorized_Namespace, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(product_Year, customer_ID, authorized_Namespace, prefetchPathToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return Fetch(product_Year, customer_ID, authorized_Namespace, prefetchPathToUse, contextToUse);
		}
		...
		{
			return Fetch(this.Product_Year, this.Customer_ID, this.Authorized_Namespace, null, null);
		}
		...
		public bool TestOriginalFieldValueForNull(CustomerNamespaceAuthorizationFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(CustomerNamespaceAuthorizationFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("CustomerNamespaceAuthorizationEntity", ((TestHarness.DataObjects.EntityType)typeOfEntity).ToString());
		}
		...
		/// <summary> Event thrower for the Authorized_NamespaceChanged event, which is thrown when Authorized_Namespace changes value. Databinding related.</summary>
		protected virtual void OnAuthorized_NamespaceChanged()
		{
			if(Authorized_NamespaceChanged!=null)
			{
				Authorized_NamespaceChanged(this, new EventArgs());
			}
		}
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn)
			{
				switch((CustomerNamespaceAuthorizationFieldIndex)fieldIndex)
				{
		...
		{
			CustomerNamespaceAuthorizationDAO dao = (CustomerNamespaceAuthorizationDAO)CreateDAOInstance();
		...
		{
			return new CustomerNamespaceAuthorizationValidator();
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="validator">The validator object for this CustomerNamespaceAuthorizationEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, IValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse, IPrefetchPath prefetchPathToUse)
		{
			InitClassMembers(propertyDescriptorFactoryToUse, entityFactoryToUse);

			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(product_Year, customer_ID, authorized_Namespace, prefetchPathToUse, null);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Authorized_Namespace", fieldHashtable);
			fieldHashtable = new Hashtable();
		...
		private void DesetupSyncCustomerName(bool signalRelatedEntity)
		{
			if(_customerName != null)
			{
				...
				_customerName.AfterSave-=new EventHandler(OnEntityAfterSave);
				base.UnsetEntitySyncInformation("CustomerName", _customerName, CustomerNamespaceAuthorizationEntity.Relations.CustomerNameEntityUsingCustomer_ID);
				if(signalRelatedEntity)
				{
					_customerName.UnsetRelatedEntity(this, "CustomerNamespaceAuthorization");
				}
				SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Customer_ID, null, false);
				_customerName = null;
			}
		}
		...
		private void SetupSyncCustomerName(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_alreadyFetchedCustomerName = true;
				_customerName.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("CustomerName", _customerName, CustomerNamespaceAuthorizationEntity.Relations.CustomerNameEntityUsingCustomer_ID);
		...
		private void DesetupSyncEnum_AuthorizationType(bool signalRelatedEntity)
		{
			if(_enum_AuthorizationType != null)
			{
				...
				_enum_AuthorizationType.AfterSave-=new EventHandler(OnEntityAfterSave);
				base.UnsetEntitySyncInformation("Enum_AuthorizationType", _enum_AuthorizationType, CustomerNamespaceAuthorizationEntity.Relations.Enum_AuthorizationTypeEntityUsingAuthorizationType_EnumValue);
				if(signalRelatedEntity)
				{
					_enum_AuthorizationType.UnsetRelatedEntity(this, "CustomerNamespaceAuthorization");
				}
				SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.AuthorizationType_EnumValue, null, false);
				_enum_AuthorizationType = null;
			}
		}
		...
		private void SetupSyncEnum_AuthorizationType(IEntity relatedEntity)
		{
			...
			if(relatedEntity!=null)
			{
				...
				_alreadyFetchedEnum_AuthorizationType = true;
				_enum_AuthorizationType.AfterSave+=new EventHandler(OnEntityAfterSave);
				base.SetEntitySyncInformation("Enum_AuthorizationType", _enum_AuthorizationType, CustomerNamespaceAuthorizationEntity.Relations.Enum_AuthorizationTypeEntityUsingAuthorizationType_EnumValue);
		...
		/// <param name="contextToUse">The context to add the entity to if the fetch was succesful. </param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int16 product_Year, System.Int32 customer_ID, System.String authorized_Namespace, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				OnFetch();
				IDao dao = this.CreateDAOInstance();
				base.Fields[(int)CustomerNamespaceAuthorizationFieldIndex.Product_Year].ForcedCurrentValueWrite(product_Year);
				base.Fields[(int)CustomerNamespaceAuthorizationFieldIndex.Customer_ID].ForcedCurrentValueWrite(customer_ID);
				base.Fields[(int)CustomerNamespaceAuthorizationFieldIndex.Authorized_Namespace].ForcedCurrentValueWrite(authorized_Namespace);
		...
		{
			return DAOFactory.CreateCustomerNamespaceAuthorizationDAO();
		}
		...
		{
			return new CustomerNamespaceAuthorizationEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static CustomerNamespaceAuthorizationRelations Relations
		{
			get	{ return new CustomerNamespaceAuthorizationRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathCustomerName
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(),
					CustomerNamespaceAuthorizationEntity.Relations.CustomerNameEntityUsingCustomer_ID, 
					(int)TestHarness.DataObjects.EntityType.CustomerNamespaceAuthorizationEntity, (int)TestHarness.DataObjects.EntityType.CustomerNameEntity, 0, null, null, null, "CustomerName", RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathEnum_AuthorizationType
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.Enum_AuthorizationTypeCollection(),
					CustomerNamespaceAuthorizationEntity.Relations.Enum_AuthorizationTypeEntityUsingAuthorizationType_EnumValue, 
					(int)TestHarness.DataObjects.EntityType.CustomerNamespaceAuthorizationEntity, (int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity, 0, null, null, null, "Enum_AuthorizationType", RelationType.ManyToOne);
			}
		}
		...
		{
			get { return CustomerNamespaceAuthorizationEntity.CustomProperties;}
		}
		...
		{
			get { return CustomerNamespaceAuthorizationEntity.FieldsCustomProperties;}
		}

		/// <summary> The Product_Year property of the Entity CustomerNamespaceAuthorization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CustomerNamespaceAuthorization"."Product_Year"<br/>
		...
		public virtual System.Int16 Product_Year
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Product_Year);
			...
			set	{ SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Product_Year, value); }
		}
		/// <summary> The Customer_ID property of the Entity CustomerNamespaceAuthorization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CustomerNamespaceAuthorization"."Customer_ID"<br/>
		...
		public virtual System.Int32 Customer_ID
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Customer_ID);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Customer_ID, value); }
		}
		/// <summary> The Authorized_Namespace property of the Entity CustomerNamespaceAuthorization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CustomerNamespaceAuthorization"."Authorized_Namespace"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.String Authorized_Namespace
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Authorized_Namespace);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.Authorized_Namespace, value); }
		}
		/// <summary> The AuthorizationType_EnumValue property of the Entity CustomerNamespaceAuthorization<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "CustomerNamespaceAuthorization"."AuthorizationType_EnumValue"<br/>
		...
		public virtual System.Byte AuthorizationType_EnumValue
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.AuthorizationType_EnumValue);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)CustomerNamespaceAuthorizationFieldIndex.AuthorizationType_EnumValue, value); }
		}
		...
		public virtual CustomerNameEntity CustomerName
		{
			...
			set
			{
				...
				else
				{
					...
					{
						((IEntity)value).SetRelatedEntity(this, "CustomerNamespaceAuthorization");
					}
				}
			}
		}
		...
		{ 
			get { return (int)TestHarness.DataObjects.EntityType.CustomerNamespaceAuthorizationEntity; }
		}
		#endregion
