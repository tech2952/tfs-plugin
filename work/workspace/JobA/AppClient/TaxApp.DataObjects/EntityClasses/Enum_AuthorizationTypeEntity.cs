...
namespace TestHarness.DataObjects.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Enum_AuthorizationType'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class Enum_AuthorizationTypeEntity : EntityBase, ISerializable
			...
			
	{
		...
		private TestHarness.DataObjects.CollectionClasses.CustomerNameCollection _customerNameCollectionViaCustomerLocatorAuthorization;
		private bool	_alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization, _alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization;
		private TestHarness.DataObjects.CollectionClasses.CustomerNameCollection _customerNameCollectionViaCustomerNamespaceAuthorization;
		private bool	_alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization, _alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization;
		...
		static Enum_AuthorizationTypeEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public Enum_AuthorizationTypeEntity()
		{
		...
		/// <summary>CTor</summary>
		/// <param name="enum_Value">PK value for Enum_AuthorizationType which data should be fetched into this Enum_AuthorizationType object</param>
		public Enum_AuthorizationTypeEntity(System.Byte enum_Value)
		{
		...
		public Enum_AuthorizationTypeEntity(System.Byte enum_Value, IPrefetchPath prefetchPathToUse)
		{
		...
		/// <summary>CTor</summary>
		/// <param name="enum_Value">PK value for Enum_AuthorizationType which data should be fetched into this Enum_AuthorizationType object</param>
		/// <param name="validator">The custom validator object for this Enum_AuthorizationTypeEntity</param>
		public Enum_AuthorizationTypeEntity(System.Byte enum_Value, Enum_AuthorizationTypeValidator validator)
		{
		...
		public Enum_AuthorizationTypeEntity(System.Byte enum_Value, Enum_AuthorizationTypeValidator validator, IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		public Enum_AuthorizationTypeEntity(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
		...
		protected Enum_AuthorizationTypeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			_customerNameCollectionViaCustomerLocatorAuthorization = (TestHarness.DataObjects.CollectionClasses.CustomerNameCollection)info.GetValue("_customerNameCollectionViaCustomerLocatorAuthorization", typeof(TestHarness.DataObjects.CollectionClasses.CustomerNameCollection));
			_alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization = info.GetBoolean("_alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization");
			_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization = info.GetBoolean("_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization");
			_customerNameCollectionViaCustomerNamespaceAuthorization = (TestHarness.DataObjects.CollectionClasses.CustomerNameCollection)info.GetValue("_customerNameCollectionViaCustomerNamespaceAuthorization", typeof(TestHarness.DataObjects.CollectionClasses.CustomerNameCollection));
			_alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization = info.GetBoolean("_alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization");
			_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization = info.GetBoolean("_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization");
		...
		public override void ReadXml(System.Xml.XmlNode node)
		{
			...
			_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization = (_customerNameCollectionViaCustomerLocatorAuthorization.Count > 0);
			_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization = (_customerNameCollectionViaCustomerNamespaceAuthorization.Count > 0);
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue("_customerNameCollectionViaCustomerLocatorAuthorization", _customerNameCollectionViaCustomerLocatorAuthorization);
			info.AddValue("_alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization", _alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization);
			info.AddValue("_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization", _alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization);
			info.AddValue("_customerNameCollectionViaCustomerNamespaceAuthorization", _customerNameCollectionViaCustomerNamespaceAuthorization);
			info.AddValue("_alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization", _alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization);
			info.AddValue("_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization", _alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization);
		...
		public override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomerNamespaceAuthorization":
					...
					break;
				case "CustomerNameCollectionViaCustomerLocatorAuthorization":
					_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization = true;
					if(entity!=null)
					{
						this.CustomerNameCollectionViaCustomerLocatorAuthorization.Add((CustomerNameEntity)entity);
					}
					break;
				case "CustomerNameCollectionViaCustomerNamespaceAuthorization":
					_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization = true;
					if(entity!=null)
					{
						this.CustomerNameCollectionViaCustomerNamespaceAuthorization.Add((CustomerNameEntity)entity);
					}
					break;
		...
		public bool TestOriginalFieldValueForNull(Enum_AuthorizationTypeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(Enum_AuthorizationTypeFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("Enum_AuthorizationTypeEntity", ((TestHarness.DataObjects.EntityType)typeOfEntity).ToString());
		}
		...
		public virtual TestHarness.DataObjects.CollectionClasses.CustomerLocatorAuthorizationCollection GetMultiCustomerLocatorAuthorization(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCustomerLocatorAuthorization || forceFetch || _alwaysFetchCustomerLocatorAuthorization) && !base.IsSerializing && !base.IsDeserializing && !EntityCollectionBase.InDesignMode)
			{
				...
				_customerLocatorAuthorization.GetMultiManyToOne(null, this, filter);
		...
		public virtual TestHarness.DataObjects.CollectionClasses.CustomerNamespaceAuthorizationCollection GetMultiCustomerNamespaceAuthorization(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedCustomerNamespaceAuthorization || forceFetch || _alwaysFetchCustomerNamespaceAuthorization) && !base.IsSerializing && !base.IsDeserializing && !EntityCollectionBase.InDesignMode)
			{
				...
				_customerNamespaceAuthorization.GetMultiManyToOne(null, this, filter);
		...
		public TestHarness.DataObjects.CollectionClasses.CustomerNameCollection GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization(bool forceFetch)
		{
			return GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization(forceFetch, _customerNameCollectionViaCustomerLocatorAuthorization.EntityFactoryToUse);
		}
		...
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public TestHarness.DataObjects.CollectionClasses.CustomerNameCollection GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization || forceFetch || _alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization) && !base.IsSerializing && !base.IsDeserializing && !EntityCollectionBase.InDesignMode)
			{
				if(base.ParticipatesInTransaction)
				{
					if(!_customerNameCollectionViaCustomerLocatorAuthorization.ParticipatesInTransaction)
					{
						base.Transaction.Add(_customerNameCollectionViaCustomerLocatorAuthorization);
					}
				}
				...
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(Enum_AuthorizationTypeFieldIndex.Enum_Value), ComparisonOperator.Equal, this.Enum_Value));
				_customerNameCollectionViaCustomerLocatorAuthorization.SuppressClearInGetMulti=!forceFetch;
				if(entityFactoryToUse!=null)
				{
					_customerNameCollectionViaCustomerLocatorAuthorization.EntityFactoryToUse = entityFactoryToUse;
				}
				_customerNameCollectionViaCustomerLocatorAuthorization.GetMulti(filter, relations);
				_customerNameCollectionViaCustomerLocatorAuthorization.SuppressClearInGetMulti=false;
				_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization = true;
			}
			return _customerNameCollectionViaCustomerLocatorAuthorization;
		}

		/// <summary> Sets the collection parameters for the collection for 'CustomerNameCollectionViaCustomerLocatorAuthorization'. These settings will be taken into account
		/// when the property CustomerNameCollectionViaCustomerLocatorAuthorization is requested or GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersCustomerNameCollectionViaCustomerLocatorAuthorization(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_customerNameCollectionViaCustomerLocatorAuthorization.SortClauses=sortClauses;
			_customerNameCollectionViaCustomerLocatorAuthorization.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}

		/// <summary> Retrieves all related entities of type 'CustomerNameEntity' using a relation of type 'm:n'.</summary>
		/// <param name="forceFetch">if true, it will discard any changes currently in the collection and will rerun the complete query instead</param>
		/// <returns>Filled collection with all related entities of type 'CustomerNameEntity'</returns>
		public TestHarness.DataObjects.CollectionClasses.CustomerNameCollection GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization(bool forceFetch)
		{
			return GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization(forceFetch, _customerNameCollectionViaCustomerNamespaceAuthorization.EntityFactoryToUse);
		}
		...
		/// <param name="entityFactoryToUse">The entity factory to use for the GetMultiManyToMany() routine.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public TestHarness.DataObjects.CollectionClasses.CustomerNameCollection GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
 			if( ( !_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization || forceFetch || _alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization) && !base.IsSerializing && !base.IsDeserializing && !EntityCollectionBase.InDesignMode)
			{
				if(base.ParticipatesInTransaction)
				{
					if(!_customerNameCollectionViaCustomerNamespaceAuthorization.ParticipatesInTransaction)
					{
						base.Transaction.Add(_customerNameCollectionViaCustomerNamespaceAuthorization);
					}
				}
				IRelationCollection relations = new RelationCollection();
				IPredicateExpression filter = new PredicateExpression();
				...
				filter.Add(new FieldCompareValuePredicate(EntityFieldFactory.Create(Enum_AuthorizationTypeFieldIndex.Enum_Value), ComparisonOperator.Equal, this.Enum_Value));
				_customerNameCollectionViaCustomerNamespaceAuthorization.SuppressClearInGetMulti=!forceFetch;
				if(entityFactoryToUse!=null)
				{
					_customerNameCollectionViaCustomerNamespaceAuthorization.EntityFactoryToUse = entityFactoryToUse;
				}
				_customerNameCollectionViaCustomerNamespaceAuthorization.GetMulti(filter, relations);
				_customerNameCollectionViaCustomerNamespaceAuthorization.SuppressClearInGetMulti=false;
				_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization = true;
			}
			return _customerNameCollectionViaCustomerNamespaceAuthorization;
		}

		/// <summary> Sets the collection parameters for the collection for 'CustomerNameCollectionViaCustomerNamespaceAuthorization'. These settings will be taken into account
		/// when the property CustomerNameCollectionViaCustomerNamespaceAuthorization is requested or GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization is called.</summary>
		/// <param name="maxNumberOfItemsToReturn"> The maximum number of items to return. When set to 0, this parameter is ignored</param>
		/// <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified (null), no sorting is applied.</param>
		public virtual void SetCollectionParametersCustomerNameCollectionViaCustomerNamespaceAuthorization(long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
			_customerNameCollectionViaCustomerNamespaceAuthorization.SortClauses=sortClauses;
			_customerNameCollectionViaCustomerNamespaceAuthorization.MaxNumberOfItemsToReturn=maxNumberOfItemsToReturn;
		}
		...
		protected override bool SetNewFieldValue(int fieldIndex, object value, bool checkForRefetch)
		{
			...
			if(toReturn)
			{
				switch((Enum_AuthorizationTypeFieldIndex)fieldIndex)
				{
					default:
						break;
				}
		...
		{
			Enum_AuthorizationTypeDAO dao = (Enum_AuthorizationTypeDAO)CreateDAOInstance();
		...
		protected override void AddInternalsToContext()
		{
			...
			_customerNameCollectionViaCustomerLocatorAuthorization.ActiveContext = base.ActiveContext;
			_customerNameCollectionViaCustomerNamespaceAuthorization.ActiveContext = base.ActiveContext;
		...
		{
			return new Enum_AuthorizationTypeValidator();
		}
		...
		/// <param name="propertyDescriptorFactoryToUse">PropertyDescriptor factory to use in GetItemProperties method of contained collections. Complex databinding related.</param>
		/// <param name="entityFactoryToUse">The EntityFactory to use when creating entity objects during a GetMulti() call.</param>
		/// <param name="validator">The validator object for this Enum_AuthorizationTypeEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers(IPropertyDescriptorFactory propertyDescriptorFactoryToUse, IEntityFactory entityFactoryToUse)
		{
			...
			_customerLocatorAuthorization.SetContainingEntityInfo(this, "Enum_AuthorizationType");
			...
			_customerNamespaceAuthorization.SetContainingEntityInfo(this, "Enum_AuthorizationType");
			_alwaysFetchCustomerNamespaceAuthorization = false;
			_alreadyFetchedCustomerNamespaceAuthorization = false;
			_customerNameCollectionViaCustomerLocatorAuthorization = new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(propertyDescriptorFactoryToUse, new CustomerNameEntityFactory());
			_alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization = false;
			_alreadyFetchedCustomerNameCollectionViaCustomerLocatorAuthorization = false;
			_customerNameCollectionViaCustomerNamespaceAuthorization = new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(propertyDescriptorFactoryToUse, new CustomerNameEntityFactory());
			_alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization = false;
			_alreadyFetchedCustomerNameCollectionViaCustomerNamespaceAuthorization = false;
		...
		private bool Fetch(System.Byte enum_Value, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			try
			{
				...
				base.Fields[(int)Enum_AuthorizationTypeFieldIndex.Enum_Value].ForcedCurrentValueWrite(enum_Value);
		...
		{
			return DAOFactory.CreateEnum_AuthorizationTypeDAO();
		}
		...
		{
			return new Enum_AuthorizationTypeEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static Enum_AuthorizationTypeRelations Relations
		{
			get	{ return new Enum_AuthorizationTypeRelations(); }
		}
		...
		public static IPrefetchPathElement PrefetchPathCustomerLocatorAuthorization
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerLocatorAuthorizationCollection(),
					Enum_AuthorizationTypeEntity.Relations.CustomerLocatorAuthorizationEntityUsingAuthorizationType_EnumValue, 
					(int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity, (int)TestHarness.DataObjects.EntityType.CustomerLocatorAuthorizationEntity, 0, null, null, null, "CustomerLocatorAuthorization", RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathCustomerNamespaceAuthorization
		{
			get
			{
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerNamespaceAuthorizationCollection(),
					Enum_AuthorizationTypeEntity.Relations.CustomerNamespaceAuthorizationEntityUsingAuthorizationType_EnumValue, 
					(int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity, (int)TestHarness.DataObjects.EntityType.CustomerNamespaceAuthorizationEntity, 0, null, null, null, "CustomerNamespaceAuthorization", RelationType.OneToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCustomerNameCollectionViaCustomerLocatorAuthorization
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(Enum_AuthorizationTypeEntity.Relations.CustomerLocatorAuthorizationEntityUsingAuthorizationType_EnumValue);
				relations.Add(CustomerLocatorAuthorizationEntity.Relations.CustomerNameEntityUsingCustomer_ID);
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(),
					Enum_AuthorizationTypeEntity.Relations.CustomerLocatorAuthorizationEntityUsingAuthorizationType_EnumValue,
					(int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity, (int)TestHarness.DataObjects.EntityType.CustomerNameEntity, 0, null, null, relations, "CustomerNameCollectionViaCustomerLocatorAuthorization", RelationType.ManyToMany);
			}
		}
		...
		/// for this entity. Add the object returned by this property to an existing PrefetchPath instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement implementation.</returns>
		public static IPrefetchPathElement PrefetchPathCustomerNameCollectionViaCustomerNamespaceAuthorization
		{
			get
			{
				IRelationCollection relations = new RelationCollection();
				relations.Add(Enum_AuthorizationTypeEntity.Relations.CustomerNamespaceAuthorizationEntityUsingAuthorizationType_EnumValue);
				relations.Add(CustomerNamespaceAuthorizationEntity.Relations.CustomerNameEntityUsingCustomer_ID);
				return new PrefetchPathElement(new TestHarness.DataObjects.CollectionClasses.CustomerNameCollection(),
					Enum_AuthorizationTypeEntity.Relations.CustomerNamespaceAuthorizationEntityUsingAuthorizationType_EnumValue,
					(int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity, (int)TestHarness.DataObjects.EntityType.CustomerNameEntity, 0, null, null, relations, "CustomerNameCollectionViaCustomerNamespaceAuthorization", RelationType.ManyToMany);
			}
		}
		...
		{
			get { return Enum_AuthorizationTypeEntity.CustomProperties;}
		}
		...
		{
			get { return Enum_AuthorizationTypeEntity.FieldsCustomProperties;}
		}

		/// <summary> The Enum_Value property of the Entity Enum_AuthorizationType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Enum_AuthorizationType"."Enum_Value"<br/>
		...
		public virtual System.Byte Enum_Value
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)Enum_AuthorizationTypeFieldIndex.Enum_Value);
			...
			set	{ SetNewFieldValue((int)Enum_AuthorizationTypeFieldIndex.Enum_Value, value); }
		}
		/// <summary> The Enum_Description property of the Entity Enum_AuthorizationType<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Enum_AuthorizationType"."Enum_Description"<br/>
		...
		public virtual System.String Enum_Description
		{
			get
			{
				object valueToReturn = base.GetCurrentFieldValue((int)Enum_AuthorizationTypeFieldIndex.Enum_Description);
				if(valueToReturn == null)
				{
			...
			set	{ SetNewFieldValue((int)Enum_AuthorizationTypeFieldIndex.Enum_Description, value); }
		}
		...
		/// <summary> Retrieves all related entities of type 'CustomerNameEntity' using a relation of type 'm:n'.</summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual TestHarness.DataObjects.CollectionClasses.CustomerNameCollection CustomerNameCollectionViaCustomerLocatorAuthorization
		{
			get { return GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for CustomerNameCollectionViaCustomerLocatorAuthorization. When set to true, CustomerNameCollectionViaCustomerLocatorAuthorization is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time CustomerNameCollectionViaCustomerLocatorAuthorization is accessed. You can always execute
		/// a forced fetch by calling GetMultiCustomerNameCollectionViaCustomerLocatorAuthorization(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization
		{
			get	{ return _alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization; }
			set	{ _alwaysFetchCustomerNameCollectionViaCustomerLocatorAuthorization = value; }	
		}
		/// <summary> Retrieves all related entities of type 'CustomerNameEntity' using a relation of type 'm:n'.</summary>
		/// <remarks>This property is added for databinding conveniance, however it is recommeded to use the method 'GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization()', because 
		/// this property is rather expensive and a method tells the user to cache the result when it has to be used more than once in the same scope.</remarks>
		public virtual TestHarness.DataObjects.CollectionClasses.CustomerNameCollection CustomerNameCollectionViaCustomerNamespaceAuthorization
		{
			get { return GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization(false); }
		}

		/// <summary> Gets / sets the lazy loading flag for CustomerNameCollectionViaCustomerNamespaceAuthorization. When set to true, CustomerNameCollectionViaCustomerNamespaceAuthorization is always refetched from the 
		/// persistent storage. When set to false, the data is only fetched the first time CustomerNameCollectionViaCustomerNamespaceAuthorization is accessed. You can always execute
		/// a forced fetch by calling GetMultiCustomerNameCollectionViaCustomerNamespaceAuthorization(true).</summary>
		[Browsable(false)]
		public bool AlwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization
		{
			get	{ return _alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization; }
			set	{ _alwaysFetchCustomerNameCollectionViaCustomerNamespaceAuthorization = value; }	
		}
		...
		{ 
			get { return (int)TestHarness.DataObjects.EntityType.Enum_AuthorizationTypeEntity; }
		}
		#endregion
