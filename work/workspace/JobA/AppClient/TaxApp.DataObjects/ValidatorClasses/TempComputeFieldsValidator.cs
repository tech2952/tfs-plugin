...
{
	/// <summary>
	/// Implementation of the TempComputeFields Validator class. This class formulates validation rules for the
	/// TempComputeFieldsEntity class. It is plugged into an instance of the TempComputeFieldsEntity class using the Strategy
	...
	/// TempComputeFieldsEntity class instead of an instance of this class. The TempComputeFieldsEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class TempComputeFieldsValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public TempComputeFieldsValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add TempComputeFieldsValidator.Validate implementation
			return true ;
