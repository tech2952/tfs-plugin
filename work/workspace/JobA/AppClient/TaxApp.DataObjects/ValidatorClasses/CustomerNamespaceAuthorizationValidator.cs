...
{
	/// <summary>
	/// Implementation of the CustomerNamespaceAuthorization Validator class. This class formulates validation rules for the
	/// CustomerNamespaceAuthorizationEntity class. It is plugged into an instance of the CustomerNamespaceAuthorizationEntity class using the Strategy
	...
	/// CustomerNamespaceAuthorizationEntity class instead of an instance of this class. The CustomerNamespaceAuthorizationEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerNamespaceAuthorizationValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CustomerNamespaceAuthorizationValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add CustomerNamespaceAuthorizationValidator.Validate implementation
			return true ;
