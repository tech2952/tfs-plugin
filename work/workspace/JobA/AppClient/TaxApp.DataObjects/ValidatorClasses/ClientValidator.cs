...
{
	/// <summary>
	/// Implementation of the Client Validator class. This class formulates validation rules for the
	/// ClientEntity class. It is plugged into an instance of the ClientEntity class using the Strategy
	...
	/// ClientEntity class instead of an instance of this class. The ClientEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class ClientValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add ClientValidator.Validate implementation
			return true ;
