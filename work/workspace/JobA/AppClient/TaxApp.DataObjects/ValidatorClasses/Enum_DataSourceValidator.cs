...
{
	/// <summary>
	/// Implementation of the Enum_DataSource Validator class. This class formulates validation rules for the
	/// Enum_DataSourceEntity class. It is plugged into an instance of the Enum_DataSourceEntity class using the Strategy
	...
	/// Enum_DataSourceEntity class instead of an instance of this class. The Enum_DataSourceEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class Enum_DataSourceValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public Enum_DataSourceValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add Enum_DataSourceValidator.Validate implementation
			return true ;
