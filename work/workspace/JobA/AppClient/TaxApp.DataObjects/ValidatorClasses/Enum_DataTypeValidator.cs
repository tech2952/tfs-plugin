...
{
	/// <summary>
	/// Implementation of the Enum_DataType Validator class. This class formulates validation rules for the
	/// Enum_DataTypeEntity class. It is plugged into an instance of the Enum_DataTypeEntity class using the Strategy
	...
	/// Enum_DataTypeEntity class instead of an instance of this class. The Enum_DataTypeEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class Enum_DataTypeValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public Enum_DataTypeValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add Enum_DataTypeValidator.Validate implementation
			return true ;
