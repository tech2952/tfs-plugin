...
{
	/// <summary>
	/// Implementation of the ClientLocator Validator class. This class formulates validation rules for the
	/// ClientLocatorEntity class. It is plugged into an instance of the ClientLocatorEntity class using the Strategy
	...
	/// ClientLocatorEntity class instead of an instance of this class. The ClientLocatorEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class ClientLocatorValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ClientLocatorValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add ClientLocatorValidator.Validate implementation
			return true ;
