...
{
	/// <summary>
	/// Implementation of the LocatorObjectValue Validator class. This class formulates validation rules for the
	/// LocatorObjectValueEntity class. It is plugged into an instance of the LocatorObjectValueEntity class using the Strategy
	...
	/// LocatorObjectValueEntity class instead of an instance of this class. The LocatorObjectValueEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorObjectValueValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorObjectValueValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorObjectValueValidator.Validate implementation
			return true ;
