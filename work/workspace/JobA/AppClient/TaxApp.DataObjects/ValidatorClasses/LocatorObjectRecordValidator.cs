...
{
	/// <summary>
	/// Implementation of the LocatorObjectRecord Validator class. This class formulates validation rules for the
	/// LocatorObjectRecordEntity class. It is plugged into an instance of the LocatorObjectRecordEntity class using the Strategy
	...
	/// LocatorObjectRecordEntity class instead of an instance of this class. The LocatorObjectRecordEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorObjectRecordValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorObjectRecordValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorObjectRecordValidator.Validate implementation
			return true ;
