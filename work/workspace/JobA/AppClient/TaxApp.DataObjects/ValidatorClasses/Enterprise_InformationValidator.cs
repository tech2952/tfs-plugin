...
{
	/// <summary>
	/// Implementation of the Enterprise_Information Validator class. This class formulates validation rules for the
	/// Enterprise_InformationEntity class. It is plugged into an instance of the Enterprise_InformationEntity class using the Strategy
	...
	/// Enterprise_InformationEntity class instead of an instance of this class. The Enterprise_InformationEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class Enterprise_InformationValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public Enterprise_InformationValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add Enterprise_InformationValidator.Validate implementation
			return true ;
