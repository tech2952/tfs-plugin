...
{
	/// <summary>
	/// Implementation of the LocatorNodeComputedValue Validator class. This class formulates validation rules for the
	/// LocatorNodeComputedValueEntity class. It is plugged into an instance of the LocatorNodeComputedValueEntity class using the Strategy
	...
	/// LocatorNodeComputedValueEntity class instead of an instance of this class. The LocatorNodeComputedValueEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorNodeComputedValueValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorNodeComputedValueValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorNodeComputedValueValidator.Validate implementation
			return true ;
