...
{
	/// <summary>
	/// Implementation of the LocatorGridRow Validator class. This class formulates validation rules for the
	/// LocatorGridRowEntity class. It is plugged into an instance of the LocatorGridRowEntity class using the Strategy
	...
	/// LocatorGridRowEntity class instead of an instance of this class. The LocatorGridRowEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorGridRowValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorGridRowValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorGridRowValidator.Validate implementation
			return true ;
