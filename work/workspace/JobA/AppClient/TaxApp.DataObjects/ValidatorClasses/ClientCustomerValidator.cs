...
{
	/// <summary>
	/// Implementation of the ClientCustomer Validator class. This class formulates validation rules for the
	/// ClientCustomerEntity class. It is plugged into an instance of the ClientCustomerEntity class using the Strategy
	...
	/// ClientCustomerEntity class instead of an instance of this class. The ClientCustomerEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class ClientCustomerValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public ClientCustomerValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add ClientCustomerValidator.Validate implementation
			return true ;
