...
{
	/// <summary>
	/// Implementation of the LocatorRollover Validator class. This class formulates validation rules for the
	/// LocatorRolloverEntity class. It is plugged into an instance of the LocatorRolloverEntity class using the Strategy
	...
	/// LocatorRolloverEntity class instead of an instance of this class. The LocatorRolloverEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorRolloverValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorRolloverValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorRolloverValidator.Validate implementation
			return true ;
