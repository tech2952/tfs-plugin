...
{
	/// <summary>
	/// Implementation of the TempComputedResults Validator class. This class formulates validation rules for the
	/// TempComputedResultsEntity class. It is plugged into an instance of the TempComputedResultsEntity class using the Strategy
	...
	/// TempComputedResultsEntity class instead of an instance of this class. The TempComputedResultsEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class TempComputedResultsValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public TempComputedResultsValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add TempComputedResultsValidator.Validate implementation
			return true ;
