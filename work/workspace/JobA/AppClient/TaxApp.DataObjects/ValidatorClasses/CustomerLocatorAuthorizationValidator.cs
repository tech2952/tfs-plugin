...
{
	/// <summary>
	/// Implementation of the CustomerLocatorAuthorization Validator class. This class formulates validation rules for the
	/// CustomerLocatorAuthorizationEntity class. It is plugged into an instance of the CustomerLocatorAuthorizationEntity class using the Strategy
	...
	/// CustomerLocatorAuthorizationEntity class instead of an instance of this class. The CustomerLocatorAuthorizationEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerLocatorAuthorizationValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CustomerLocatorAuthorizationValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add CustomerLocatorAuthorizationValidator.Validate implementation
			return true ;
