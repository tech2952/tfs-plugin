...
{
	/// <summary>
	/// Implementation of the Firm Validator class. This class formulates validation rules for the
	/// FirmEntity class. It is plugged into an instance of the FirmEntity class using the Strategy
	...
	/// FirmEntity class instead of an instance of this class. The FirmEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class FirmValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add FirmValidator.Validate implementation
			return true ;
