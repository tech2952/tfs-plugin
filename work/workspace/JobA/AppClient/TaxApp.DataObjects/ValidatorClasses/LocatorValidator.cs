...
{
	/// <summary>
	/// Implementation of the Locator Validator class. This class formulates validation rules for the
	/// LocatorEntity class. It is plugged into an instance of the LocatorEntity class using the Strategy
	...
	/// LocatorEntity class instead of an instance of this class. The LocatorEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class LocatorValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorValidator()
		{
		}
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add LocatorValidator.Validate implementation
			return true ;
