...
{
	/// <summary>
	/// Implementation of the CustomerName Validator class. This class formulates validation rules for the
	/// CustomerNameEntity class. It is plugged into an instance of the CustomerNameEntity class using the Strategy
	...
	/// CustomerNameEntity class instead of an instance of this class. The CustomerNameEntity code will then call your
	...
	/// </remarks>
	[Serializable]
	public partial class CustomerNameValidator : IValidator
	{
		/// <summary>
		/// CTor
		/// </summary>
		...
		public virtual bool Validate(int fieldIndex, object value)
		{
			...
			// TODO:  Add CustomerNameValidator.Validate implementation
			return true ;
