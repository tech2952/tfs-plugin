...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Client Entity. It will perform database oriented actions for
	/// a entity of type 'ClientEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class ClientDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ClientDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ClientEntity", new ClientEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.ClientEntity);
		...
		/// <summary>
		/// Retrieves in the calling ClientCollection object all ClientEntity objects
		...
		/// <param name="pageSize">The page size of the page to retrieve.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLocatorCollectionViaClientLocator(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity locatorInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.ClientEntity);
			RelationCollection relations = new RelationCollection();
...
selectFilter.Add(new FieldCompareValuePredicate(locatorInstance.Fields[(int)LocatorFieldIndex.Locator_ID], ComparisonOperator.Equal));
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLocatorCollectionViaClientLocator(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity locatorInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.ClientEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(ClientEntity.Relations.ClientLocatorEntityUsingProduct_YearClient_ID, "ClientLocator_");
