...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Enterprise_Information Entity. It will perform database oriented actions for
	/// a entity of type 'Enterprise_InformationEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class Enterprise_InformationDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public Enterprise_InformationDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "Enterprise_InformationEntity", new Enterprise_InformationEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.Enterprise_InformationEntity);
