...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the TempComputeFields Entity. It will perform database oriented actions for
	/// a entity of type 'TempComputeFieldsEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class TempComputeFieldsDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public TempComputeFieldsDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "TempComputeFieldsEntity", new TempComputeFieldsEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.TempComputeFieldsEntity);
