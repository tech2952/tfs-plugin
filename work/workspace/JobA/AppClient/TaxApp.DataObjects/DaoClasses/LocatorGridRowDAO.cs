...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the LocatorGridRow Entity. It will perform database oriented actions for
	/// a entity of type 'LocatorGridRowEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class LocatorGridRowDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public LocatorGridRowDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "LocatorGridRowEntity", new LocatorGridRowEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.LocatorGridRowEntity);
