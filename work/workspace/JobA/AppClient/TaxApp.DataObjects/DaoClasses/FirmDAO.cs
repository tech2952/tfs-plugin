...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Firm Entity. It will perform database oriented actions for
	/// a entity of type 'FirmEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class FirmDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public FirmDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "FirmEntity", new FirmEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.FirmEntity);
