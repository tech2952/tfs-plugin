...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Locator Entity. It will perform database oriented actions for
	/// a entity of type 'LocatorEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class LocatorDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public LocatorDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "LocatorEntity", new LocatorEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.LocatorEntity);
		...
		/// <summary>
		/// Retrieves in the calling LocatorCollection object all LocatorEntity objects
		...
		public bool GetMultiUsingClientCollectionViaClientLocator(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity clientInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.LocatorEntity);
...
selectFilter.Add(new FieldCompareValuePredicate(clientInstance.Fields[(int)ClientFieldIndex.Client_ID], ComparisonOperator.Equal));
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingClientCollectionViaClientLocator(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IValidator validatorToUse, IEntity clientInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.LocatorEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(LocatorEntity.Relations.ClientLocatorEntityUsingProduct_YearLocator_ID, "ClientLocator_");
