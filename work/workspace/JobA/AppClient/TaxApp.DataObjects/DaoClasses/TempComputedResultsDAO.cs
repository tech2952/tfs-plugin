...
namespace TestHarness.DataObjects.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the TempComputedResults Entity. It will perform database oriented actions for
	/// a entity of type 'TempComputedResultsEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class TempComputedResultsDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public TempComputedResultsDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "TempComputedResultsEntity", new TempComputedResultsEntityFactory(), new TypeDefaultValue())
		{
		}
		...
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(TestHarness.DataObjects.EntityType.TempComputedResultsEntity);
