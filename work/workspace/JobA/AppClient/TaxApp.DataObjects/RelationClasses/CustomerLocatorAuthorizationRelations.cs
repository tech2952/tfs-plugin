...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: CustomerLocatorAuthorization.
	/// This class is generated. Do not modify.
	/// </summary>
	public partial class CustomerLocatorAuthorizationRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		public CustomerLocatorAuthorizationRelations()
		{
		}
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerLocatorAuthorizationEntity and CustomerNameEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerLocatorAuthorization.Customer_ID - CustomerName.Customer_ID
		/// </summary>
		public virtual IEntityRelation CustomerNameEntityUsingCustomer_ID
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerLocatorAuthorizationEntity", true);
				return relation;
			}
		}
	
		/// <summary>Returns a new IEntityRelation object, between CustomerLocatorAuthorizationEntity and Enum_AuthorizationTypeEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerLocatorAuthorization.AuthorizationType_EnumValue - Enum_AuthorizationType.Enum_Value
		/// </summary>
