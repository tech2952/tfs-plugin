...
{
	/// <summary>
	/// Implements the static Relations variant for the entity: LocatorRollover.
	/// This class is generated. Do not modify.
	/// </summary>
	public partial class LocatorRolloverRelations
	{
		/// <summary>
		/// CTor
		/// </summary>
		public LocatorRolloverRelations()
		{
		}
		...
		/// <summary>Returns a new IEntityRelation object, between LocatorRolloverEntity and LocatorEntity over the m:1 relation they have, using the relation between the fields:
		/// LocatorRollover.Product_Year - Locator.Product_Year
		/// LocatorRollover.Target_Locator_ID - Locator.Locator_ID
		/// </summary>
		public virtual IEntityRelation LocatorEntityUsingProduct_YearTarget_Locator_ID
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("LocatorRolloverEntity", true);
				return relation;
			}
		}
		...
		/// <summary>Returns a new IEntityRelation object, between LocatorRolloverEntity and LocatorEntity over the m:1 relation they have, using the relation between the fields:
		/// LocatorRollover.Product_Year - Locator.Product_Year
		/// LocatorRollover.Source_Locator_ID - Locator.Locator_ID
		/// </summary>
		public virtual IEntityRelation LocatorEntityUsingProduct_YearSource_Locator_ID
		{
			get
			{
